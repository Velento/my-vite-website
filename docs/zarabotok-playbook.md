...
Дай боссу `REPORT_TOKEN` чтобы он мог независимо открыть дашборд:
```
https://legalline-form-proxy.legalline.workers.dev/dashboard?token=5d70d232df3a06dd74578195fccf84517fcb4cdf3aa93f19f451be663cbda4d0
```
Это исключит споры — он сам видит цифру.
