  ...
  resources: {
    en: {
      translation: {
        ...
        'packages.title': 'Karta Pobytu Packages',
        'packages.promo': 'Promotion valid until the end of the month!',
        ...
        'packages.allInclusive.features.3': 'Delivering documents by power of attorney',
        'packages.allInclusive.features.4':
          'Personal escort for fingerprints and inspector meetings',
        'packages.allInclusive.features.5': 'Letters/complaints to accelerate the process',
        ...
        'packages.ultra.features.0': 'Focus on maximum speed',
        'packages.ultra.features.1': 'Filing a lawsuit in case of delays',
        'packages.ultra.features.2': 'Licensed attorney',
        'packages.ultra.features.3': 'Full support from MOS to card issuance',
        'packages.ultra.features.4':
          'Court acceleration (including fee, lawsuit drafting, court representation)',
        'packages.basic.title': 'Basic',
        'packages.basic.price': '750 PLN',
        'packages.basic.features.0': 'Document and form preparation',
        ...
        'reason_texts.reason2':
          "If we don't call you back within 45 minutes after you submit a request on the site, we will give you a 50 PLN discount on the purchase of a service.",
        'reason_texts.reason3':
          'If you do not achieve the result, we will refund your money within 7 days. We work under contract!',
        ...
        'trustBar.experience': '5+ years of experience',
        'trustBar.languages': '5 languages of service',
        ...
        cookieUsageDescription:
          'We use cookies to ensure the basic functionalities of the website and to enhance your online experience. You can choose for each category to opt-in/out whenever you want. For more details about cookies and other sensitive data.',
        ...
        benefits: {
          ...
          reason1: {
            ...
            content:
              'We consider price affordability to be the most important criterion in our work. We always have special offers on popular services that you can check out on this website.',
          },
          reason2: {
          ...
          reason3: {
            ...
            content:
              'If, through our fault, you receive a refusal for the residence permit, we will refund the full amount. Additionally, if we did everything correctly but you were still denied the permit, we will file an appeal or process a new permit for free.',
          },
          reason4: {
            title: 'Communication with the office in Polish on your behalf.',
            content:
              'When you sign a contract with us, you will not need to visit the office. We will handle all communications in Polish, write letters to officials, and file complaints or lawsuits if necessary.',
          },
          reason5: {
            title: 'We are always in touch.',
            content:
              'You can rest assured, as we take care of all legalization matters. However, if you have any questions, you are always welcome to visit our office or call us. Our contact details and working hours are listed on the website.',
          },
          reason6: {
            title: 'Access to a personal account.',
            content:
              'If you prefer to monitor the status of your case yourself, we will provide you with access to a personal account on the official government website.',
          },
        },
        team: {
          title: 'Our Team',
        ...
        section1: {
          ...
          content:
            'We work under a contract with a money-back guarantee. This means that if something goes wrong and if you do not receive the final result due to our fault, we will refund you the full amount for our services.',
          buttonText: 'I WANT TO SIGN A CONTRACT',
        },
        section2: {
          title: 'Contact us now to find out how to solve your issue as quickly as possible!',
          content:
            'Contact us right now! Feel free to ask our specialist a question. We will respond as quickly as possible.',
          buttonText: 'I WANT A QUICK ANSWER',
        },
        section3: {
          title: 'Participate in the raffle for lifelong free legal assistance. Raffle every month',
          content:
            "We want to provide as much benefit as possible. We often consult people for free. However, many need comprehensive legal assistance, which is not always affordable. So don't miss your chance! You can become the winner of the raffle in our Instagram group. Subscribe and play!",
        ...
        section5: {
          ...
          content:
            'Write to us in one of three messengers. Describe your situation and indicate what kind of help you need. Our specialists will study your case and send a clear plan of action.',
        ...
        services: {
          ...
          businessVisa: 'Case Acceleration Through Court Lawsuit',
          ...
          'Service1.moreInfoService': {
            ...
            content:
              'The temporary residence card or residence permit is a document that confirms the identity of a foreigner during their stay in Poland and allows for multiple border crossings without a visa, official work, and the purchase of movable and immovable property in Poland.',
          },
          ...
          'Service3.basicPackage': {
            title: 'Basic Package: 500 PLN',
            content:
              '1) Consultation. 2) Document analysis and missing document checklist. 3) Document package review before submission. 4) Collection and preparation of the complete document package.',
            button: 'I WANT THE BASIC PACKAGE',
          },
          ...
          'Service3.moreInfoService': {
            ...
            content:
              'Getting married in Poland is not as easy as it seems. The complexity lies in the fact that document processing can take up to 10-12 months. We will help you quickly prepare all the documents and obtain a marriage permit from the appropriate authorities.',
          },
          'Service3.processingTime': {
            title: 'Marriage Document Processing Time',
            content:
              'The processing time for marriage documents in Gdańsk is on average 7 months. For marriage in the USA while physically in Poland, document preparation times average 2 months.',
          },
          'Service4.cost': 'Cost',
          ...
          'Service4.basicPackage': {
            title: 'Pre-trial Acceleration',
            content:
              '1) Consultation and case analysis. 2) Preparation and sending of complaints to the voivodeship office. 3) Drafting demands for case acceleration. 4) Monitoring response deadlines. 5) Correspondence with the authority.',
            button: 'I WANT PRE-TRIAL ACCELERATION',
          },
          'Service4.allInclusivePackage': {
            title: 'Acceleration Through Court',
            content:
              '1) Full pre-trial stage. 2) Preparation of a lawsuit for inactivity of the authority. 3) Licensed attorney representation. 4) Court fee included. 5) Full court support until a decision is obtained. 6) Case monitoring and correspondence with the court. 7) Contact with the inspector handling your case.',
            button: 'I WANT COURT ACCELERATION',
          },
          ...
          'Service4.processingTime': {
            ...
            content:
              'Pre-trial acceleration: 2-4 weeks for authority response. Court acceleration: on average 2-3 months from lawsuit filing to decision.',
          },
          'Service5.cost': 'Cost',
          ...
          'Service6.allInclusivePackage': {
            title: 'Price: 350 PLN',
            content:
              'If you want to manage your case yourself, and you have the time and experience in document processing, but you are unsure about legal issues, then order a consultation with our lawyer.',
            button: 'I WANT A CONSULTATION FOR 350 PLN',
          },
          'Service6.moreInfoService': {
            title: 'Consultation',
            content:
              'Maybe you want to handle your case yourself and you have the time for it. Therefore, a consultation is most suitable for you. Clarify contentious issues and control your case yourself.',
          },
          ...
          'Service7.basicPackage': {
            title: 'Basic Package: 500 PLN',
            content:
              '1) Consultation. 2) Comprehensive analysis of documents. 3) Resume (CV) and cover letter review. 4) Provision of sample resumes (CV) and cover letters.',
            button: 'I WANT THE BASIC PACKAGE',
          },
          'Service7.allInclusivePackage': {
            title: 'All-Inclusive Package: 1500 PLN',
            content:
              '1) Consultation. 2) Comprehensive analysis of documents. 3) Resume (CV) and cover letter writing and preparation. 4) Provision of sample resumes (CV) and cover letters. 5) Writing a letter of recommendation and reference. 6) Detailed job search instructions. 7) PESEL number preparation if needed. 8) Trusted profile registration (profil zaufany) if needed. 9) In case of a negative decision due to our fault - full refund.',
            button: 'I WANT THE ALL-INCLUSIVE PACKAGE',
          },
          'Service7.moreInfoService': {
            title: 'Resume (CV) Writing',
            content:
              'Our team of professional HR specialists will help you prepare a perfect resume (CV) and cover letter, as well as provide detailed job search instructions. With our help, you will significantly increase your chances of finding a job in Poland or another country.',
          },
          'Service7.processingTime': {
            title: 'Resume (CV) Writing Processing Time',
            content:
              'The processing time for resume (CV) and cover letter preparation in Gdańsk is on average 2 weeks.',
          },
          'Service8.cost': 'Cost',
          ...
          'Service8.basicPackage': {
            ...
            content:
              '1) Consultation. 2) Comprehensive analysis of documents. 3) Civil document review. 4) Provision of sample civil documents.',
            button: 'I WANT THE BASIC PACKAGE',
          },
          'Service8.allInclusivePackage': {
            title: 'All-Inclusive Package: 2000 PLN',
            content:
              '1) Consultation. 2) Comprehensive analysis of documents. 3) Civil document preparation. 4) Collection and preparation of the complete document package. 5) PESEL number preparation if needed. 6) Trusted profile registration (profil zaufany) if needed. 7) In case of a negative decision due to our fault - full refund.',
            button: 'I WANT THE ALL-INCLUSIVE PACKAGE',
          },
          'Service8.moreInfoService': {
            title: 'Civil Document Preparation',
            content:
              'We provide professional assistance in the preparation of civil documents, including applications, petitions, and other necessary documents for various civil procedures in Poland and other countries.',
          },
    ...
    pl: {
      translation: {
        ...
        'pricelistservices.1.title':
          'Pomoc w przygotowaniu dokumentów do złożenia wniosku o obywatelstwo',
        ...
        'packages.title': 'Pakiety Karta Pobytu',
        'packages.promo': 'Promocja ważna do końca miesiąca!',
        ...
        'packages.allInclusive.features.3': 'Doniesienie dokumentów na podstawie pełnomocnictwa',
        'packages.allInclusive.features.4':
          'Osobiste towarzyszenie na odciski palców i do inspektora',
        'packages.allInclusive.features.5': 'Pisma/skargi przyspieszające sprawę',
        'packages.standard.title': 'Standard',
        'packages.standard.price': '1 100 PLN',
        ...
        'packages.ultra.price': '2 400 PLN',
        'packages.ultra.features.0': 'Nacisk na maksymalną szybkość',
        'packages.ultra.features.1': 'Złożenie pozwu sądowego w razie opóźnień',
        'packages.ultra.features.2': 'Adwokat z licencją',
        'packages.ultra.features.3': 'Pełne wsparcie od MOS do wydania karty',
        'packages.ultra.features.4':
          'Przyspieszenie przez sąd (opłata, pozew, reprezentacja w sądzie)',
        'packages.basic.title': 'Podstawowy',
        'packages.basic.price': '750 PLN',
        'packages.basic.features.0': 'Przygotowanie dokumentów i wniosków',
        ...
        'reason_texts.reason2':
          'Jeśli nie oddzwonimy do Ciebie w ciągu 45 minut od wysłania zapytania na stronie, otrzymasz 50 PLN zniżki na zakup usługi.',
        'reason_texts.reason3':
          'Jeśli nie osiągniesz rezultatu, zwrócimy Ci pieniądze w ciągu 7 dni. Pracujemy na podstawie umowy!',
        ...
        'trustBar.experience': '5+ lat doświadczenia',
        'trustBar.languages': '5 języków obsługi',
        ...
        cookieUsageDescription:
          'Używamy plików cookie, aby zapewnić podstawowe funkcje strony internetowej i poprawić Twoje doświadczenia online. Możesz wybrać wyrazić zgodę/zrezygnować dla każdej kategorii w dowolnym momencie. Więcej szczegółów dotyczących plików cookie i innych danych wrażliwych.',
        ...
        benefits: {
          ...
          reason1: {
            ...
            content:
              'Uważamy przystępność cen za najważniejsze kryterium w naszej pracy. Zawsze mamy promocje na popularne usługi, które można znaleźć na naszej stronie.',
          },
          reason2: {
          ...
          reason3: {
            ...
            content:
              'Jeśli z naszej winy otrzymasz odmowę wydania karty pobytu, zwrócimy Ci całą kwotę. Co więcej, jeśli wszystko zrobiliśmy poprawnie, ale z jakiegoś powodu odmówiono Ci wydania karty, bezpłatnie złożymy odwołanie lub przygotujemy nową kartę pobytu.',
          },
          reason4: {
            title: 'Komunikacja w urzędzie po polsku za Ciebie.',
            content:
              'Podpisując z nami umowę, nie musisz osobiście odwiedzać urzędu. Prowadzimy negocjacje po polsku, piszemy pisma do urzędników, składamy skargi lub pozwy do sądu.',
          },
          reason5: {
            title: 'Jesteśmy zawsze w kontakcie.',
            content:
              'Możesz być spokojny, ponieważ zajmiemy się wszystkimi kwestiami związanymi z legalizacją. Jednak jeśli pojawi się pytanie, zawsze możesz nas odwiedzić w biurze lub zadzwonić. Nasze dane kontaktowe i godziny otwarcia znajdują się na stronie.',
          },
          reason6: {
            title: 'Zapewniamy dostęp do panelu klienta.',
            content:
              'Jeśli chcesz samodzielnie monitorować status swojej sprawy, zapewniamy Ci dostęp do panelu klienta na oficjalnej stronie urzędu.',
          },
        },
        team: {
          title: 'Nasz zespół',
        ...
        section1: {
          ...
          content:
            'Pracujemy na umowie z gwarancją zwrotu pieniędzy. To oznacza, że jeśli coś pójdzie nie tak i jeśli z naszej winy nie uzyskasz końcowego rezultatu, zwrócimy ci całą kwotę za nasze usługi.',
          buttonText: 'CHCĘ PODPISAĆ UMOWĘ',
        },
        section2: {
          title: 'Skontaktuj się teraz i dowiedz się, jak szybko rozwiązać swój problem!',
          content:
            'Skontaktuj się z nami teraz! Śmiało zadawaj pytania naszemu specjaliście. Odpowiemy na nie jak najszybciej.',
          buttonText: 'CHCĘ SZYBKĄ ODPOWIEDŹ',
        },
        section3: {
          title:
            'Weź udział w losowaniu dożywotniej bezpłatnej pomocy prawnej. Losowanie co miesiąc',
          content:
            'Chcemy dostarczyć jak najwięcej korzyści z naszej strony. Często konsultujemy ludzi za darmo. Jednak wielu potrzebuje kompleksowej pomocy prawnej, na którą nie zawsze znajdują się finanse. Dlatego nie przegap swojej szansy! Możesz zostać zwycięzcą losowania w naszej grupie na Instagramie. Subskrybuj i graj!',
        ...
        section5: {
          ...
          content:
            'Napisz do nas w jednym z trzech komunikatorów. Opisz swoją sytuację i wskaż, jaka pomoc jest ci potrzebna. Nasi specjaliści przeanalizują twoją sytuację i wyślą jasny plan działania.',
        ...
        services: {
          ...
          businessVisa: 'Przyspieszenie spraw przez pozew sądowy',
          ...
          'Service1.moreInfoService': {
            ...
            content:
              'Karta czasowego pobytu lub zezwolenie na pobyt to dokument, który potwierdza tożsamość cudzoziemca podczas jego pobytu w Polsce, a także daje prawo do wielokrotnego przekraczania granicy bez uzyskania wizy, legalnej pracy, zakupu nieruchomości i ruchomości w Polsce.',
          },
          'Service1.processingTime': {
          ...
          'Service3.basicPackage': {
            title: 'Pakiet podstawowy: 500 zł',
            content:
              '1) Konsultacja. 2) Analiza aktualnych dokumentów i sporządzenie listy brakujących. 3) Sprawdzenie pakietu dokumentów przed złożeniem. 4) Zbieranie i przygotowanie pełnego pakietu dokumentów.',
            button: 'CHCĘ PAKIET PODSTAWOWY',
          },
          'Service3.allInclusivePackage': {
            title: 'Pakiet "Wszystko w cenie": 1500 zł',
            content:
              '1) Konsultacja. 2) Pomoc w przygotowaniu dokumentów. 3) Pomoc w organizacji ceremonii ślubnej online. 4) Przygotowanie dokumentów do zawarcia małżeństwa w USA, będąc fizycznie w Polsce. 5) Pełne wsparcie przy zawarciu małżeństwa na terenie Polski. 6) Wypełnianie wszystkich formularzy. 7) Monitorowanie sprawy, odbieranie korespondencji, składanie wszystkich niezbędnych dokumentów. 8) Kontakt z instytucją wydającą zezwolenie na zawarcie małżeństwa. 9) Kompleksowe wsparcie w twojej sprawie aż do uzyskania decyzji o zawarciu małżeństwa. 10) Przygotowanie numeru PESEL w razie potrzeby. 11) Rejestracja zaufanego profilu (profil zaufany) w razie potrzeby. 12) W przypadku negatywnej decyzji z naszej winy - pełny zwrot kosztów.',
            button: 'CHCĘ PAKIET "WSZYSTKO W CENIE"',
          },
          'Service3.moreInfoService': {
            title: 'Małżeństwo',
            content:
              'Zawarcie małżeństwa w Polsce nie jest tak proste, jak się wydaje. Trudność polega na tym, że rozpatrywanie dokumentów może trwać od 10 do 12 miesięcy. Pomożemy maksymalnie szybko przygotować wszystkie dokumenty i uzyskać zezwolenie na zawarcie małżeństwa w specjalnych instkontrolnych placówkach.',
          },
          'Service3.processingTime': {
            title: 'Czas oczekiwania na dokumenty do zawarcia małżeństwa',
            content:
              'Czas oczekiwania na dokumenty do zawarcia małżeństwa w Gdańsku wynosi średnio 7 miesięcy. Przy zawarciu małżeństwa w USA, będąc fizycznie w Polsce, czas przygotowania dokumentów wynosi średnio 2 miesiące.',
          },
          'Service4.cost': 'Koszt',
          ...
          'Service4.basicPackage': {
            title: 'Przyspieszenie przedsądowe',
            content:
              '1) Konsultacja i analiza sprawy. 2) Przygotowanie i wysłanie skarg do urzędu wojewódzkiego. 3) Sporządzenie wezwań do przyspieszenia sprawy. 4) Monitorowanie terminów odpowiedzi. 5) Korespondencja z organem.',
            button: 'CHCĘ PRZYSPIESZENIE PRZEDSĄDOWE',
          },
          'Service4.allInclusivePackage': {
            title: 'Przyspieszenie przez sąd',
            content:
              '1) Pełny etap przedsądowy. 2) Przygotowanie pozwu na bezczynność organu. 3) Reprezentacja przez adwokata z licencją. 4) Opłata sądowa w cenie. 5) Pełne wsparcie sądowe aż do uzyskania decyzji. 6) Monitorowanie sprawy i korespondencja z sądem. 7) Kontakt z inspektorem prowadzącym sprawę.',
            button: 'CHCĘ PRZYSPIESZENIE PRZEZ SĄD',
          },
          'Service4.moreInfoService': {
          ...
          'Service4.processingTime': {
            ...
            content:
              'Przyspieszenie przedsądowe: 2-4 tygodnie na odpowiedź organu. Przyspieszenie przez sąd: średnio 2-3 miesiące od złożenia pozwu do decyzji.',
          },
          'Service5.cost': 'Koszt',
          ...
          'Service5.allInclusivePackage': {
            title: 'Pakiet "Wszystko w cenie": 1500 zł',
            content:
              '1) Konsultacja. 2) Pomoc w przygotowaniu dokumentów. 3) Zbieranie i przygotowanie pełnego pakietu dokumentów. 4) Wypełnianie wszystkich formularzy. 5) Rejestracja na osobiste złożenie dokumentów. Monitorowanie sprawy, odbieranie korespondencji, składanie wszystkich niezbędnych dokumentów. 6) Kontakt z instytucjami. 7) Kompleksowe wsparcie w Twojej sprawie aż do uzyskania decyzji. 8) Przygotowanie numeru PESEL w razie potrzeby. 9) Rejestracja zaufanego profilu (profil zaufany) w razie potrzeby. 10) W przypadku negatywnej decyzji z naszej winy - pomoc w przygotowaniu dokumentów na odwołanie i pełny zwrot kosztów.',
            button: 'CHCĘ PAKIET "WSZYSTKO W CENIE"',
          },
          'Service5.moreInfoService': {
            title: 'Wymiana prawa jazdy na polskie',
            content:
              'Po pół roku pobytu w Polsce należy wymienić prawo jazdy swojego kraju na polskie. Oczywiste jest, że jeśli nie chcesz wymieniać prawa jazdy, nawet jeśli przebywasz w Polsce przez długi czas, grozi Ci kara administracyjna.',
          },
          'Service5.processingTime': {
          ...
          'Service6.allInclusivePackage': {
            title: 'Cena: 350 zł',
            content:
              'Jeśli chcesz samodzielnie monitorować swoją sprawę, a także masz czas i doświadczenie w przygotowywaniu dokumentów, ale masz wątpliwości co do kwestii prawnych, zamów konsultację u naszego prawnika.',
            button: 'CHCĘ KONSULTACJĘ ZA 350 zł',
          },
          'Service6.moreInfoService': {
            title: 'Konsultacja',
            content:
              'Może chcesz samodzielnie zajmować się swoją sprawą i masz na to czas. W takim przypadku konsultacja jest dla Ciebie najbardziej odpowiednia. Wyjaśnij wątpliwe kwestie i sam monitoruj swoją sprawę.',
          },
          'Service6.processingTime': {
          ...
          'Service7.moreInfoService': {
            ...
            content:
              'Aby Twoja kandydatura wyglądała atrakcyjnie, należy odpowiednio sporządzić CV. To znacznie zwiększy szanse na zaakceptowanie Cię jako wykwalifikowanego pracownika dla firmy.',
          },
          'Service7.processingTime': {
            title: 'Czas oczekiwania',
            content: '1-2 dni',
          ...
          'Service8.basicPackage': {
            ...
            content:
              '1) Konsultacja. 2) Analiza aktualnych dokumentów i sporządzenie listy brakujących. 3) Sprawdzenie pakietu dokumentów przed złożeniem. 4) Zbieranie i przygotowanie pełnego pakietu dokumentów. 5) Wypełnianie wszystkich formularzy.',
            button: 'ZAMÓWIĆ',
          },
          'Service8.allInclusivePackage': {
            title: 'Pakiet "Wszystko w cenie": 2000 zł',
            content:
              '1) Konsultacja. 2) Pomoc w przygotowaniu dokumentów. 3) Zbieranie i przygotowanie pełnego pakietu dokumentów. 4) Wypełnianie wszystkich formularzy. 5) Monitorowanie sprawy, odbieranie korespondencji, składanie wszystkich niezbędnych dokumentów. 6) Kompleksowe wsparcie w Twojej sprawie aż do uzyskania decyzji. 7) W przypadku negatywnej decyzji z naszej winy - pomoc w przygotowaniu dokumentów na odwołanie i pełny zwrot kosztów.',
            button: 'ZAMÓWIĆ',
          },
          'Service8.moreInfoService': {
            title: 'Paszport obywatela Polski',
            content:
              'Obywatelstwo Polski daje prawo do nieograniczonego pobytu, legalnego zatrudnienia, uzyskiwania usług medycznych oraz gwarantowanej ochrony przez państwo. Jednym z wymagań do uzyskania paszportu jest zdanie specjalnego testu sprawdzającego znajomość języka, a także kultury i historii kraju.',
          },
          'Service8.processingTime': {
            title: 'Czas oczekiwania',
    ...
    ua: {
      translation: {
        ...
        'packages.ultra.features.4':
          'Прискорення через суд (мито, складання позову, супровід у суді)',
    ...
    by: {
      translation: {
        ...
        'pricelistservices.1.title':
          'Дапамога ў падрыхтоўцы дакументаў для падачы на грамадзянства',
        ...
        'packages.ultra.features.4':
          'Паскарэнне праз суд (пошліна, складанне іску, суправод у судзе)',
        ...
        messageAlert:
          'Дзякуй за заяўку! Нашы спецыялісты ўжо змагаюцца, хто хутчэй да вас патэлефануе:)',
        ...
        section3: {
          title:
            'Удзельнічай у латэрыі даўжаной бясплатнай юрыдычнай дапамогі. Латэрыя кожны месяц',
          content:
    ...
    ru: {
      translation: {
        ...
        'pricelistservices.0.title':
          'Комплексная помощь в подготовке документов для подачи на Карту Побыта',
        ...
        'packages.title': 'Пакеты Карта Побыту',
        'packages.promo': 'Акция действует до конца месяца!',
        ...
        'packages.ultra.price': '2 400 PLN',
        'packages.ultra.features.0': 'Фокус на максимальную скорость',
        'packages.ultra.features.1': 'Подача иска в суд при задержках',
        'packages.ultra.features.2': 'Адвокат с лицензией',
        'packages.ultra.features.3': 'Полное сопровождение от MOS до получения карты',
        'packages.ultra.features.4':
          'Ускорение через суд (включая пошлину, составление иска и сопровождение в суде)',
        'packages.basic.title': 'Базовый',
        'packages.basic.price': '750 PLN',
        'packages.basic.features.0': 'Подготовка документов и анкет',
        ...
        'reason_texts.reason3':
          'Если вы не добьетесь результата, мы вернем ваши деньги в течение 7 дней. Мы работаем по договору!',
        ...
        'trustBar.experience': '5+ лет опыта',
        'trustBar.languages': '5 языков обслуживания',
        ...
        cookieMessage:
          'Мы используем файлы cookie! Этот сайт использует необходимые файлы cookie для обеспечения его правильной работы и файлы cookie для отслеживания, чтобы понять, как вы взаимодействуете с ним. Последние будут установлены только после согласия.',
        allowMeToChoose: 'Позвольте мне выбрать',
        acceptAll: 'Принять все',
        decline: 'Отклонить',
        cookieSettings: 'Настройки файлов cookie',
        cookieUsageDescription:
          'Мы используем файлы cookie, чтобы обеспечить основные функции веб-сайта и улучшить ваш онлайн-опыт. Вы можете выбрать для каждой категории, дать согласие или отказаться в любое время. Подробнее о файлах cookie и других конфиденциальных данных.',
        ...
        benefits: {
          ...
          reason1: {
            ...
            content:
              'Доступность цен мы считаем самым главным критерием в нашей работе. У нас всегда есть акции на популярные услуги, которые вы сможете посмотреть на данном сайте.',
          },
          reason2: {
          ...
          reason3: {
            ...
            content:
              'Если по нашей вине вам дадут отказ в выдаче карты побыту, то мы возвращаем вам всю сумму. Кроме того, если мы все сделали правильно, но по какой-то причине вам отказали в карте, то мы бесплатно подадим апелляцию или сделаем вам новую карту побыту бесплатно.',
          },
          reason4: {
            title: 'Общение в Ужонде за вас на польском языке.',
            content:
              'При заключении договора с нами, вы не будете посещать Ужонд. Мы сами проведем переговоры на польском языке, напишем письма должностным лицам, подадим жалобу или иск в суд.',
          },
          reason5: {
            title: 'Мы всегда на связи.',
            content:
              'Вы можете быть спокойны, так как все вопросы по легализации мы берем на себя. Однако, если у вас возникнет вопрос, вы всегда можете прийти к нам в офис или позвонить. Наши контакты и режим работы указаны на сайте.',
          },
          reason6: {
            title: 'Предоставляем доступ к личному кабинету.',
            content:
              'Если вы хотите сами контролировать статус вашего дела, то мы предоставим вам доступ к личному кабинету на государственном сайте Ужонда.',
          },
        },
        ...
        section1: {
          ...
          content:
            'Мы работаем по договору с гарантией возврата денег. Это значит, что если что-то пойдет не по плану и если по нашей вине ты не получишь конечного результата, то мы вернем тебе всю сумму за наши услуги.',
          buttonText: 'ХОЧУ ЗАКЛЮЧИТЬ ДОГОВОР',
        },
        section2: {
          title: 'Свяжись сейчас и узнай как решить твой вопрос максимально быстро!',
          content:
            'Свяжись с нами прямо сейчас! Смело задавай вопрос нашему специалисту. Мы ответим на него максимально быстро.',
          buttonText: 'ХОЧУ БЫСТРЫЙ ОТВЕТ',
        },
        section3: {
          title:
            'Участвуй в розыгрыше пожизненной бесплатной юридической помощи. Розыгрыш каждый месяц',
          content:
            'Мы хотим дать максимально пользы с нашей стороны. Мы часто консультируем людей бесплатно. Однако многие нуждаются в оказании комплексной юридической помощи, на которую не всегда находятся финансы. Поэтому не упускай свой шанс! Ты можешь стать победителем розыгрыша в нашей группе Инстаграм. Подписывайся и играй!',
        ...
        section5: {
          ...
          content:
            'Напиши нам в один из трех мессенджеров. Опиши свою ситуацию и укажи, какая помощь тебе нужна. Наши специалисты изучат твою ситуацию и отправят четкий план действий.',
          buttonText: 'ХОЧУ ПЛАН',
        },
        services: {
          ...
          businessVisa: 'Ускорение дел через судебный иск',
          ...
          'Service1.moreInfoService': {
            ...
            content:
              'Карта временного пребывания или вид на жительство - это документ, который подтверждает личность иностранца во время его пребывания в Польше, а также дает право многократно пересекать границу без получения визы, официально работать, покупать движимое и недвижимое имущество в Польше.',
          },
          'Service1.processingTime': {
          ...
          'Service3.basicPackage': {
            title: 'Базовый пакет: 500 зл',
            content:
              '1) Консультация. 2) Анализ актуальных документов и составление списка недостающих. 3) Проверка пакета документов перед подачей. 4) Сбор и подготовка полного пакета документов.',
            button: 'ХОЧУ БАЗОВЫЙ ПАКЕТ',
          },
          'Service3.allInclusivePackage': {
            title: 'Пакет "Всё включено": 1500 зл',
          ...
          'Service3.moreInfoService': {
            ...
            content:
              'Заключить брак в Польше не так просто как кажется. Сложность в том, что рассмотрение документов может доходить до 10-12 месяцев. Мы поможем максимально быстро оформить все документы и получить разрешение на заключение брака в специальных ведомственных учреждениях.',
          },
          'Service3.processingTime': {
            title: 'Срок получения документов для бракосочетания',
            content:
              'Срок получения документов для заключения брака в Гданьске составляет в среднем 7 месяцев. При Заключении брака в США, физически находясь в Польше, сроки подготовки документов в среднем составляют 2 месяца ',
          },
          ...
          'Service4.basicPackage': {
            title: 'Досудебное ускорение',
            content:
              '1) Консультация и анализ дела. 2) Подготовка и отправка жалоб в воеводское управление. 3) Составление требований об ускорении дела. 4) Мониторинг сроков ответа. 5) Корреспонденция с органом.',
            button: 'ХОЧУ ДОСУДЕБНОЕ УСКОРЕНИЕ',
          },
          'Service4.allInclusivePackage': {
            title: 'Ускорение через суд',
            content:
              '1) Полный досудебный этап. 2) Подготовка иска на бездействие органа. 3) Представительство лицензированным адвокатом. 4) Судебный сбор включён. 5) Полное сопровождение в суде до получения решения. 6) Мониторинг дела и корреспонденция с судом. 7) Контакт с инспектором, ведущим дело.',
            button: 'ХОЧУ УСКОРЕНИЕ ЧЕРЕЗ СУД',
          },
          'Service4.moreInfoService': {
          ...
          'Service4.processingTime': {
            ...
            content:
              'Досудебное ускорение: 2-4 недели на ответ органа. Ускорение через суд: в среднем 2-3 месяца от подачи иска до решения.',
          },
          ...
          'Service5.moreInfoService': {
            ...
            content:
              'После полугода нахождения в Польше водительское удостоверение Вашей страны необходимо менять на польское. Очевидно, что если вы не желаете менять водительское удостоверение, даже при условии того, что вы долгое время находитесь в Польше, вам грозит административный штраф.',
          },
          'Service5.processingTime': {
          ...
          'Service6.allInclusivePackage': {
            title: 'Цена: 350 зл',
            content:
              'Если вы хотите сами следить за своим делом, а также если у вас есть время и опыт в оформлении документов, но вы сомнемаетесь в юридических вопросах, то закажите консультацию у нашего юриста.',
            button: 'ХОЧУ КОНСУЛЬТАЦИЮ ЗА 350 зл.',
          },
          'Service6.moreInfoService': {
            title: 'Консультация',
            content:
              'Возможно вы сами хотите заниматься своим делом и у вас есть на это время. Поэтому консультация для вас наиболее всего подходит. Уточните спорные вопросы и сами контролируйте свое дело.',
          },
          'Service6.processingTime': {
          ...
          'Service7.moreInfoService': {
            ...
            content:
              'Чтoбы вaшa кaндидaтypa выглядeлa пpивлeкaтeльнo, нyжнo пpaвильнo cocтaвить peзюмe. Это в разы повысит шансы на одобрение вас, как квалифицированного сотрудника для компании. ',
          },
          'Service7.processingTime': {
            title: 'Срок получения',
            content: '1-2 дня',
          ...
          'Service8.basicPackage': {
            ...
            content:
              '1) Консультация. 2) Анализ актуальных документов и составление списка недостающих. 3) Проверка пакета документов перед подачей. 4) Сбор и подготовка полного пакета документов. 5) Заполнение всех анкет.',
            button: 'ЗАКАЗАТЬ',
          },
          'Service8.allInclusivePackage': {
          ...
          'Service8.moreInfoService': {
            ...
            content:
              'Гражданство Польши дает право на неограниченное проживание, официальное трудоустройство, получение медицинских услуг, гарантированную защиту государства. Одним из требований для получения паспорта является сдача специального теста для определения уровня знания языка, а также культуры и истории страны.',
          },
          'Service8.processingTime': {
            title: 'Срок получения',
