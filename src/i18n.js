      ...
      translation: {
        ...
        services: {
          ...
          'Service4.processingTime': {
            ...
            content:
              'The processing time for complaints and lawsuits is individual. If the employer does not want to go to court, the average processing time for pre-trial lawsuits is 6 months. The average processing time for court cases is 10-12 months.',
          },
          'Service5.cost': 'Cost',
      ...
      translation: {
        ...
        services: {
          ...
          'Service4.basicPackage': {
            ...
            content:
              '1) Консультація. 2) Ведення переговорів з вашим роботодавцем. 3) Складання претензій і передсудових позовів. 4) Збір і підготовка повного пакету документів для подання до суду.',
            button: 'ХОЧУ БАЗОВИЙ ПАКЕТ',
          },
          'Service4.allInclusivePackage': {
      ...
      translation: {
        ...
        services: {
          ...
          'Service4.basicPackage': {
            ...
            content:
              '1) Кансультацыя. 2) Вядзенне перамоў з вашым працадаўцам. 3) Складанне прэтэнзій і перадсудовых іскаў. 4) Збор і падрыхтоўка поўнага пакета дакументаў для падачы ў суд.',
            button: 'ХАЧУ БАЗАВЫ ПАКЕТ',
          },
          'Service4.allInclusivePackage': {
      ...
      translation: {
        ...
        services: {
          ...
          'Service4.processingTime': {
            ...
            content:
              'Срок рассмотрения жалоб и судебных исков индивидуален. Если работодатель не хочет доводить дела до суда, то можно урегулировать спор в течение месяца.',
          },
